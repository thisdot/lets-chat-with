import attendeeDesiredIdentifier from '../seed-templates/attendeeDesiredIdentifier';
...
export function generateDesiredAttendeeIdentifiers(
  attendees: OwnedEntry<{ eventId: string }>[],
  maxCount: number
) {
  return attendees
    .map((attendee) =>
      generateEntries(attendeeDesiredIdentifier, {
